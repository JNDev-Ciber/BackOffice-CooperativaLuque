...
export default function TVPlansPage() {
  ...
  async function onSubmit(e) {
    ...
    try {
      if (!editingItem) {
        await rpcCreateTVPlan(payload);
      } else {
        await rpcUpdateTVPlan(editingItem.id, payload);
      }
      resetForm();
      await load();
    } catch (e2) {
  ...
  async function confirmDelete() {
    ...
    setLoading(true);
    try {
      await rpcDeleteTVPlan(deleteTarget.id);
      await load();
    } catch (e) {
  ...
  return (
    <div style={{ maxWidth: 1600, margin: "0 auto", textAlign: "left" }}>
      <div style={{ display: "flex", alignItems: "center", marginBottom: 16 }}>
        <h2 style={{ margin: 0 }}>Planes de TV</h2>
      </div>
